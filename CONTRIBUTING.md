...
### Code Style
- Follow the [Typescript / Rust API Design Guidelines](https://www.swift.org/documentation/api-design-guidelines/).
- Use **Typescript / RustUI** best practices (unidirectional data flow, state hoisting).
