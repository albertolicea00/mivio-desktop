# Security Policy for Mivio (Mivio Desktop)

At Mivio, we take the security of our users and their media streaming setups very seriously. We want to ensure that Mivio remains a secure and trusted media center for the Mivio Desktop Ecosystem.
...
| Version | Supported |
| ------- | --------- |
| Electron / Node 18+ | :white_check_mark: Yes |
| Older Versions | :x: No |
...
4. Details of the system configuration you tested (e.g. Windows 11 PC, Ubuntu 22.04 Laptop).
